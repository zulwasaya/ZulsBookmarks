...
module ActionView
  ...
  module Helpers
    ...
    module FormTagHelper
      ...
      #
      #   file_field_tag 'file', :accept => 'text/html', :class => 'upload', :value => 'index.html.old'
      #   # => <input accept="text/html" class="upload" id="file" name="file" type="file" value="index.html.old" />
